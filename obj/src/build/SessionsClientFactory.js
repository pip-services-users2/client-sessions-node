...
const SessionsMockClientV1_1 = require("../version1/SessionsMockClientV1");
...
class SessionsClientFactory extends pip_services3_components_nodex_1.Factory {
    constructor() {
        ...
        this.registerAsType(SessionsClientFactory.MockClientV1Descriptor, SessionsMockClientV1_1.SessionsMockClientV1);
...
SessionsClientFactory.MockClientV1Descriptor = new pip_services3_commons_nodex_1.Descriptor('service-sessions', 'client', 'mock', 'default', '1.0');
