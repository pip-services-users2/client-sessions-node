...
exports.SessionsCommandableGrpcClientV1 = void 0;
const pip_services3_commons_nodex_1 = require("pip-services3-commons-nodex");
const pip_services3_grpc_nodex_1 = require("pip-services3-grpc-nodex");
class SessionsCommandableGrpcClientV1 extends pip_services3_grpc_nodex_1.CommandableGrpcClient {
    constructor(config) {
        super('v1/sessions');
        if (config != null)
    ...
    closeExpiredSessions(correlationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield this.callCommand('close_expired_sessions', null, {});
            }
            catch (err) {
                timing.endFailure(err);
                throw err;
